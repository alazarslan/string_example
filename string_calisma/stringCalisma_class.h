...
public:
    ...
    */
    void stringFind_of();
     ...
     /*
     * @brief: bir stringin istenilen yerine istenilen uzunlukta yeni karakterler ekler
     */
    void stringInsert();

    /*
    * @brief: stringin uzunluğunu değiştirir. eğerki stringin kendi uzunluğundan daha kısa bir değer
    * girilirse girilen sayıdan sonraki indexleri siler. daha büyük bir değer girilirse yanına koyulan
    * parametreye göre (koyulmayadabilir) stringin uzunluğunu arttırır ve 2. parametredeki karakteri
    * stringe ekler.
    */
    void stringResize();

    /*
     * @brief: stringin belirli bir bölümünü başka bir stringle değiştirir.
    */
    void stringReplace();

    /*
    * @brief: eğerki str'nin kapasitesi büyükse, yeterli kapasiteye düşürmeye çalışır
    * stringin içeriğini değiştirmez.
    * reserve fonksiyonu ile stringin kapasitesi büyültüldüyse bu fonksiyonu kullanıp
    * normal boyuta getirilebilir.
    */
    void stringShrinkToFit();

   /*
   * @brief: parametrelere girilen değerlere göre string'den bir alt string oluşturur.
   */
    void stringSubStr();

    /*
   * @brief: iki stringin içeriğini değiştirir, takas eder
   */
    void stringSwap();
...
/*
 * str.size(); -> uzunluğunu dönüyo, length'in aynısı. tek farkı
 * size()'ı string dışında vector ve arrayde kullanabiliyoruz
*/
